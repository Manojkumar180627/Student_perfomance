                    ...
                    <div className="pt-2">
                      {activeTab === 'STUDENTS' ? (
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <button onClick={() => handleStatusChange(u, UserStatus.REJECTED)} className="py-3 bg-white border border-rose-200 text-rose-500 rounded-xl text-[10px] font-black uppercase tracking-widest">Deny</button>
                        </div>
                      )}
                    </div>
                  </div>

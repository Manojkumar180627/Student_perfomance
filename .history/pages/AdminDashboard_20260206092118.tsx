                    ...
                    {activeTab === 'REGISTRATIONS' && pendingRegistrations.map(u => (
                      <tr key={u.id} className="text-sm font-bold text-slate-600 hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="px-8 py-7 text-right flex justify-end gap-2">
                           <button onClick={() => handleStatusChange(u, UserStatus.APPROVED)} className="px-6 py-2.5 bg-slate-900 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-indigo-600 transition-all shadow-md"></button>

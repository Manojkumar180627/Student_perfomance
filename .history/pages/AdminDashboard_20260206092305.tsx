                    ...
                    {activeTab === 'REGISTRATIONS' && pendingRegistrations.map(u => (
                      <tr key={u.id} className="text-sm font-bold text-slate-600 hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="px-8 py-7 text-right flex justify-end gap-2">
                           ...
                           <button onClick={() => handleStatusChange(u, UserStatus.REJECTED)} className="px-6 py-2.5 bg-white border border-rose-200 text-rose-500 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-rose-50 transition-all"></button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
                    ...
                    <div className="pt-2">
                      {activeTab === 'STUDENTS' ? (
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <button onClick={() => handleStatusChange(u, UserStatus.REJECTED)} className="py-3 bg-white border border-rose-200 text-rose-500 rounded-xl text-[10px] font-black uppercase tracking-widest">Reject</button>
                        </div>
                      )}
                    </div>
                  </div>
